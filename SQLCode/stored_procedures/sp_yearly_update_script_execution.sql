create procedure yearly_update_script_execution as
drop table production.dbo.yearly_update_script_execution
select YUS.date,
...
into production.dbo.yearly_update_script_execution
